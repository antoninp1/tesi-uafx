...
cd ../certs
python create_self-signed.py . -u "urn:example:uafx:temperature-sensor-1" -c temperature_server
python create_self-signed.py . -u "urn:example:uafx:density-sensor-1" -c density_server
